...
<div class="text-center py-24">
    ...
    <a href="{{ route('dashboard') }}" class="inline-block bg-blue-600 text-white px-10 py-4 rounded-full font-black hover:bg-blue-800 transition shadow-xl shadow-blue-100">KEMBALI KE BERANDA</a>
</div>
@endsection
